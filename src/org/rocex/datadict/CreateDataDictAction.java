...
public abstract class CreateDataDictAction implements IAction
{
    ...
    protected String strTreeDataModuleTemplate = "'{'id:\"{0}\",name:\"{1} {2} {3}\"'}',";  // 左树模块 链接模板
    ...
    protected void createAllTableDataDictFile(List<ClassVO> listAllTableVO) throws SQLException, Exception
    {
        ...
        new BeanListProcessor<>(PropertyVO.class, mapColumn, propertyVO ->
        {
            ...
            propertyVO.setId(StringHelper.getRandomNoRepeat(20));
            propertyVO.setSqlDateType(propertyVO.getSqlDateType().toLowerCase());
    ...
    protected void createTreeData(List<ModuleVO> listModuleVO, List<ClassVO> listClassVO, List<ClassVO> listAllTableVO)
    {
        ...
        for (ModuleVO moduleVO : listModuleVO)
        {
            ...
            strModuleRows.append(MessageFormat.format(strTreeDataModuleTemplate, getMappedModuleId(moduleVO),
        ...
        if (!listAllTableVO.isEmpty())
        {
            ...
            for (ClassVO classVO : listAllTableVO)
            {
                ...
                strClassRows.append(MessageFormat.format(strTreeDataClassTemplate, getMappedClassId(classVO), "all",
     ...
     ***************************************************************************/
    protected String getDbSqlType(PropertyVO propertyVO)
    {
        ...
        propertyVO.setSqlDateType(strDbType);
    ...
    protected synchronized String getMappedId(String strType, String strId)
    {
        ...
        String strMapId = StringHelper.getRandomNoRepeat(6);
    ...
    protected List<? extends MetaVO> queryMetaVO(Class<? extends MetaVO> metaVOClass, String strSQL)
    {
        ...
        try
        {
            listMetaVO = (List<? extends MetaVO>) sqlExecutor.executeQuery(strSQL, new BeanListProcessor<>(metaVOClass));
        }
        catch (Exception ex)
        {
            Logger.getLogger().error(ex.getMessage(), ex);
    ...
    protected List<PropertyVO> sortPropertyVO(ClassVO classVO, List<PropertyVO> listPropertyVO)
    {
        ...
        for (PropertyVO propertyVO : listPropertyVO)
        {
            ...
            if (listPk.contains(propertyVO.getName()))
            {
