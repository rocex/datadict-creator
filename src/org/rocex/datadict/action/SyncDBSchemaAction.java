...
public class SyncDBSchemaAction implements IAction
{
    ...
    protected String getDataTypeSqlBip(PropertyVO propertyVO)
    {
        ...
        if (tableNamePropertyVO != null)
        {
            ...
            if (strDataTypeSql != null && strDataTypeSql.length() > 0)
            {
    ...
    void initBipModules()
    {
        ...
        String[] strDBComponentSQLs = {"insert into md_component (id, ddc_version, model_type, name, own_module) values ('db__amc_aim', '2312-bip', 'db', 'amc_aim', 'db__am');",
            ...
            "insert into md_component (id, ddc_version, model_type, name, own_module) values ('db__cloud_attachment', '2312-bip', 'db', 'cloud_attachment', 'db__hr_cloud');",
            "insert into md_component (id, ddc_version, model_type, name, own_module) values ('db__corehr', '2312-bip', 'db', 'corehr', 'db__hr_cloud');",
            "insert into md_component (id, ddc_version, model_type, name, own_module) values ('db__diwork_cpt', '2312-bip', 'db', 'diwork_cpt', 'db__hr_cloud');",
            "insert into md_component (id, ddc_version, model_type, name, own_module) values ('db__diwork_esp', '2312-bip', 'db', 'diwork_esp', 'db__hr_cloud');",
            "insert into md_component (id, ddc_version, model_type, name, own_module) values ('db__diwork_hr_bonus', '2312-bip', 'db', 'diwork_hr_bonus', 'db__hr_cloud');",
            "insert into md_component (id, ddc_version, model_type, name, own_module) values ('db__diwork_hr_budget', '2312-bip', 'db', 'diwork_hr_budget', 'db__hr_cloud');",
            "insert into md_component (id, ddc_version, model_type, name, own_module) values ('db__diwork_pub', '2312-bip', 'db', 'diwork_pub', 'db__hr_cloud');",
            "insert into md_component (id, ddc_version, model_type, name, own_module) values ('db__diwork_talent', '2312-bip', 'db', 'diwork_talent', 'db__hr_cloud');",
            "insert into md_component (id, ddc_version, model_type, name, own_module) values ('db__diwork_train', '2312-bip', 'db', 'diwork_train', 'db__hr_cloud');",
            "insert into md_component (id, ddc_version, model_type, name, own_module) values ('db__diwork_wa', '2312-bip', 'db', 'diwork_wa', 'db__hr_cloud');",
            "insert into md_component (id, ddc_version, model_type, name, own_module) values ('db__diwork_wa_mdd', '2312-bip', 'db', 'diwork_wa_mdd', 'db__hr_cloud');",
            "insert into md_component (id, ddc_version, model_type, name, own_module) values ('db__hrattenddb', '2312-bip', 'db', 'hrattenddb', 'db__hr_cloud');",
            "insert into md_component (id, ddc_version, model_type, name, own_module) values ('db__hr_cpt', '2312-bip', 'db', 'hr_cpt', 'db__hr_cloud');",
            "insert into md_component (id, ddc_version, model_type, name, own_module) values ('db__hr_dataanalysis', '2312-bip', 'db', 'hr_dataanalysis', 'db__hr_cloud');",
            "insert into md_component (id, ddc_version, model_type, name, own_module) values ('db__hr_intelligent', '2312-bip', 'db', 'hr_intelligent', 'db__hr_cloud');",
            "insert into md_component (id, ddc_version, model_type, name, own_module) values ('db__hr_official', '2312-bip', 'db', 'hr_official', 'db__hr_cloud');",
            "insert into md_component (id, ddc_version, model_type, name, own_module) values ('db__hr_orgsystem', '2312-bip', 'db', 'hr_orgsystem', 'db__hr_cloud');",
            "insert into md_component (id, ddc_version, model_type, name, own_module) values ('db__hr_otd', '2312-bip', 'db', 'hr_otd', 'db__hr_cloud');",
            "insert into md_component (id, ddc_version, model_type, name, own_module) values ('db__hr_qualify', '2312-bip', 'db', 'hr_qualify', 'db__hr_cloud');",
            "insert into md_component (id, ddc_version, model_type, name, own_module) values ('db__hr_sinsurance', '2312-bip', 'db', 'hr_sinsurance', 'db__hr_cloud');",
            "insert into md_component (id, ddc_version, model_type, name, own_module) values ('db__hr_socialization', '2312-bip', 'db', 'hr_socialization', 'db__hr_cloud');",
            "insert into md_component (id, ddc_version, model_type, name, own_module) values ('db__hr_staffing', '2312-bip', 'db', 'hr_staffing', 'db__hr_cloud');",
            "insert into md_component (id, ddc_version, model_type, name, own_module) values ('db__performance', '2312-bip', 'db', 'performance', 'db__hr_cloud');",
            "insert into md_component (id, ddc_version, model_type, name, own_module) values ('db__ssc', '2312-bip', 'db', 'ssc', 'db__hr_cloud');",
            "insert into md_component (id, ddc_version, model_type, name, own_module) values ('db__yonbip_hr_tm', '2312-bip', 'db', 'yonbip_hr_tm', 'db__hr_cloud');",
            ...
            "insert into md_component (id, ddc_version, model_type, name, own_module) values ('db__crm', '2312-bip', 'db', 'crm', 'db__yonbip-mkt');",
            "insert into md_component (id, ddc_version, model_type, name, own_module) values ('db__omsdata', '2312-bip', 'db', 'omsdata', 'db__yonbip-mkt');",
            "insert into md_component (id, ddc_version, model_type, name, own_module) values ('db__pricecenter', '2312-bip', 'db', 'pricecenter', 'db__yonbip-mkt');",
            "insert into md_component (id, ddc_version, model_type, name, own_module) values ('db__quartz', '2312-bip', 'db', 'quartz', 'db__yonbip-mkt');",
            "insert into md_component (id, ddc_version, model_type, name, own_module) values ('db__sddcdata', '2312-bip', 'db', 'sddcdata', 'db__yonbip-mkt');",
            "insert into md_component (id, ddc_version, model_type, name, own_module) values ('db__udm', '2312-bip', 'db', 'udm', 'db__yonbip-mkt');",
            "insert into md_component (id, ddc_version, model_type, name, own_module) values ('db__uorders', '2312-bip', 'db', 'uorders', 'db__yonbip-mkt');",
            "insert into md_component (id, ddc_version, model_type, name, own_module) values ('db__upmalls', '2312-bip', 'db', 'upmalls', 'db__yonbip-mkt');",
            "insert into md_component (id, ddc_version, model_type, name, own_module) values ('db__uretaildata', '2312-bip', 'db', 'uretaildata', 'db__yonbip-mkt');",
            "insert into md_component (id, ddc_version, model_type, name, own_module) values ('db__usmp', '2312-bip', 'db', 'usmp', 'db__yonbip-mkt');",
            "insert into md_component (id, ddc_version, model_type, name, own_module) values ('db__yilian', '2312-bip', 'db', 'yilian', 'db__yonbip-mkt');",
            "insert into md_component (id, ddc_version, model_type, name, own_module) values ('db__pmcloud', '2312-bip', 'db', 'pmcloud', 'db__yonbip-pm');",
            "insert into md_component (id, ddc_version, model_type, name, own_module) values ('db__pmcloud_ods', '2312-bip', 'db', 'pmcloud_ods', 'db__yonbip-pm');",
        ...
        for (String strSrcDBSchema : strSrcDBSchemas)
        {
            executorService.execute(() ->
            {
                     ...
                     Connection connection = sqlExecutorSource.getConnection())
                {
                    ...
                    Map<String, String> mapTableNameId = syncDBTable(sqlExecutorSource, strSrcDBCatalog, strSrcDBSchema, "db__" + strSrcDBSchema);
    ...
    protected Map<String, String> syncDBTable(SQLExecutor sqlExecutorSource, String strDBCatalog, String strDBSchema, String strComponentId) throws SQLException
    {
        ...
        {
            String strDefaultTableName = Objects.toString(classVO.getDefaultTableName(), "").toLowerCase();
