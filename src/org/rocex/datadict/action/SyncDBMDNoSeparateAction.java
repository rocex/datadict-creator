 ...
 ***************************************************************************/
public class SyncDBMDNoSeparateAction implements IAction, Closeable
{
     ...
     ***************************************************************************/
    public SyncDBMDNoSeparateAction(String strVersion)
    {
        super();
        ...
        isCreateDB = Boolean.parseBoolean(Context.getInstance().getSetting("isCreateDB", "true"));
