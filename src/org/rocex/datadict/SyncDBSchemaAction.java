...
public class SyncDBSchemaAction implements IAction
{
    ...
    public SyncDBSchemaAction(String strVersion)
    {
        ...
        dbPropTarget.setProperty("jdbc.driver", strTargetDriver);
        dbPropTarget.setProperty("jdbc.password", strTargetPassword);
    ...
    protected void syncMetaData()
    {
        ...
        String strEnumValueSQL = "select id as class_id,enumsequence as enum_sequence,name,name as displayname,value enum_value,versiontype," + strOtherSQL
        ...
        queryMetaVO(EnumValueVO.class, strEnumValueSQL, null, pagingAction);
